...
class PembuatanFaktur implements Pelanggan {
    @Override
    public void konsumsi(Pemesanan pemesanan) {
        System.out.println("Invoice untuk pesanan " + pemesanan.getNomorPesanan() + " telah dibuat.");
    }
}
...
class PembuatanPesanan {
    ...
    public void buatPesanan() {
        ...
        pemesanan.setPelanggan("Chen Yuan");
        pemesanan.setPenjual("Yo Sangah");
        pemesanan.setNomorPesanan("xyz-888");
        pemesanan.setHarga(BigDecimal.TEN);
        pemesanan.setProduk("Ultra Milf");
